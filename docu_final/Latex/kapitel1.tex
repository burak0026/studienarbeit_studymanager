\chapter{Einleitung}
Die Digitalisierung hat in den letzten Jahren die Hochschullandschaft grundlegend verändert. Immer mehr Bildungsinstitutionen setzen auf digitale Informationsangebote, um Studierende, Mitarbeiter und andere Interessenten über aktuelle Entwicklungen, Veranstaltungen und andere wichtige Informationen auf dem Laufenden zu halten. Die Duale Hochschule Baden-Württemberg (DHBW) Karlsruhe ist keine Ausnahme. Mit ihrer langjährigen Erfahrung als Hochschule für angewandte Wissenschaften hat die DHBW Karlsruhe eine Vielzahl von Informationsangeboten entwickelt, um den Bedürfnissen ihrer Nutzer gerecht zu werden. Trotzdem können bei der Bereitstellung von Informationen für eine große Nutzergruppe Herausforderungen auftreten.
...
Nach der Analyse der Erfahrungen wird ein alternativer Informationsangebotsprototyp entwickelt, der auf den Bedürfnissen und Erwartungen der Studierenden basiert. Der Prototyp wird an einer ausgewählten Gruppe von Studierenden getestet, um Feedback und Verbesserungsvorschläge zu sammeln.
